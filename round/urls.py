...
urlpatterns = [
    ...
    url(r'^round/linked_streets/(?P<pk>\d+)/edit/$', create_or_edit_street, name='edit_street'),
    url(r'^round/linked_streets/(?P<pk>\d+)/$', linked_streets, name='linked_streets'),
    url(r'^round/linked_streets/(?P<pk>\d+)/view_addresses/$', view_addresses, name='view_addresses'),
    url(r'^round/linked_streets/(?P<pk>\d+)/view_addresses/(?P<pk2>\d+)/edit/$', edit_address,
        name='edit_address'),
]
